...
import { Users, TrendingUp, Calendar, Search, Plus, Eye, Edit, Mail, Phone, ChevronDown, GraduationCap, Trash2 } from "lucide-react"
...
export default function EnrollmentPage() {
  ...
  const renderStudentRows = (
    ...
    emptyMessage: string,
    colSpan: number,
    renderer: (student: EnrollmentRecord) => JSX.Element,
  ) => {

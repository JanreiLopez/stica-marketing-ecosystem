              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    className="mt-2 border border-gray-400 focus-visible:ring-orange-500 focus-visible:border-orange-500"
                  />
                </div>
                <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <Select value={newQuestionType} onValueChange={(v) => setNewQuestionType(v as any)}>
                      <SelectTrigger className="mt-2 border border-gray-400 focus-visible:ring-orange-500 focus-visible:border-orange-500">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>

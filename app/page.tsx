...
import { GraduationCap, Users, BookOpen, Award, ArrowRight, Menu } from "lucide-react"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-serif font-bold text-foreground mb-6">
              Transform Your Future with <span className="text-primary">STICA</span>
            </h1>
      ...
      <footer className="bg-primary text-primary-foreground py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-serif font-bold">STICA</span>
              </div>
          ...
          <div className="border-t border-primary-foreground/20 mt-8 pt-8 text-center text-sm text-primary-foreground/80">
            <p>&copy; 2024 STICA Educational Institution. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
